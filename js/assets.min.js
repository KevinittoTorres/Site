...
!function(t){"use strict";t.fn.counterUp=function(e){var a,n=t.extend({time:400,delay:10,offset:100,beginAt:0,formatter:!1,context:"window",callback:function(){}},e);return this.each(function(){var e=t(this),u={time:t(this).data("counterup-time")||n.time,delay:t(this).data("counterup-delay")||n.delay,offset:t(this).data("counterup-offset")||n.offset,beginAt:t(this).data("counterup-beginat")||n.beginAt,context:t(this).data("counterup-context")||n.context},r=function(){var r=[],o=u.time/u.delay,i=t(this).attr("data-num")?t(this).attr("data-num"):e.text(),c=/[0-9]+,[0-9]+/.test(i);i=i.replace(/,/g,"");var s=(i.split(".")[1]||[]).length;u.beginAt>i&&(u.beginAt=i);var f=/[0-9]+:[0-9]+:[0-9]+/.test(i);if(f){var d=i.split(":"),l=1;for(a=0;d.length>0;)a+=l*parseInt(d.pop(),10),l*=60}for(var p=o;p>=u.beginAt/i*o;p--){var h=parseFloat(i/o*p).toFixed(s);if(f){h=parseInt(a/o*p);var m=parseInt(h/3600)%24,g=parseInt(h/60)%60,v=parseInt(h%60,10);h=(m<10?"0"+m:m)+":"+(g<10?"0"+g:g)+":"+(v<10?"0"+v:v)}if(c)for(;/(\d+)(\d{3})/.test(h.toString());)h=h.toString().replace(/(\d+)(\d{3})/,"$1,$2");n.formatter&&(h=n.formatter.call(this,h)),r.unshift(h)}e.data("counterup-nums",r),e.text(u.beginAt);var b=function(){return e.data("counterup-nums")?(e.html(e.data("counterup-nums").shift()),void(e.data("counterup-nums").length?setTimeout(e.data("counterup-func"),u.delay):(e.data("counterup-nums",null),e.data("counterup-func",null),n.callback.call(this)))):void n.callback.call(this)};e.data("counterup-func",b),setTimeout(e.data("counterup-func"),u.delay)};e.waypoint(function(t){r(),this.destroy()},{offset:u.offset+"%",context:u.context})})}}(jQuery);
